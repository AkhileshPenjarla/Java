...
@Listeners({files.MyListner.class, files.MyExtentListner.class})
public class TestCases {
    ...
    @Test(priority = 8)
    public void Shopping_cart_Quantity() throws Exception {
        WebElement qtyBox = driver.findElement(By.xpath("//div[@id='quantity-up-125']"));
        qtyBox.click();
        Thread.sleep(2000);
    }
