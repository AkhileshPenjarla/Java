...
public class Annotations {
	...
	public void beforeMethod() {
		System.out.println("Navigating to orange HRM login page");
		driver.get("https:/opensource-demo.orangehrmlive.com/");
	}
	@Test(priority=1)
	...
	public void loginTest() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@name='username']"))).sendKeys("Akhilesh");
		//driver.findElement(By.xpath("//input[@name='username']")).sendKeys("Akhilesh");
